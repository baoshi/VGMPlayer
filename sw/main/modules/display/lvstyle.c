...
void lvs_init()
{
    ...
    lv_style_set_pad_right(&lvs_scrollbar, 4);
    lv_style_set_pad_top(&lvs_scrollbar, 4);
    lv_style_set_pad_bottom(&lvs_scrollbar, 4);
    ...
    lv_style_set_pad_right(&lvs_browser_file_list, 12);
}
