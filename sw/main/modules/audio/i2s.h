 ...
 *    uint32_t  tx_buf0[];      // buffer 0
 *    uint32_t  tx_buf0_len;    // buffer 0 data length
 *    uint32_t  tx_buf1[];      // buffer 1
 *    uint32_t  tx_buf1_len;    // buffer 1 data length
 *    bool      cur_tx_buf;     // current buffer buf0:false, buf1:true
 * 2. Fill tx_buf0/tx_buf0_len or tx_buf1/tx_buf1_len and set cur_tx_buf accordingly
